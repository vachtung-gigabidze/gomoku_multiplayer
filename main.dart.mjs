...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1363: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1364: a => a.length,
      _1365: (a, l) => a.length = l,
      _1366: (a, i) => a[i],
      _1367: (a, i, v) => a[i] = v,
      _1369: o => {
      ...
      _1392: (t, s) => t.set(s),
      _1393: l => new DataView(new ArrayBuffer(l)),
      ...
      _1444: (x0,x1) => new WebSocket(x0,x1),
      _1445: (x0,x1) => x0.send(x1),
      _1446: (x0,x1,x2) => x0.close(x1,x2),
      _1447: (x0,x1) => x0.close(x1),
      _1448: x0 => x0.close(),
      ...
      _1485: (x0,x1) => x0.key(x1),
      _1486: (x0,x1) => x0.item(x1),
      _1489: (x0,x1) => x0.getContext(x1),
      _1493: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      _1496: (s, m) => {
        try {
      ...
      _1563: Function.prototype.call.bind(BigInt.prototype.toString),
      _1564: Function.prototype.call.bind(Number.prototype.toString),
      _1565: (d, digits) => d.toFixed(digits),
      _1569: () => globalThis.document,
      _1590: (x0,x1) => { x0.src = x1 },
      _1591: x0 => x0.naturalWidth,
      _1592: x0 => x0.naturalHeight,
      _1608: x0 => x0.status,
      _1609: (x0,x1) => { x0.responseType = x1 },
      _1611: x0 => x0.response,
      _1750: (x0,x1) => { x0.oncancel = x1 },
      _1756: (x0,x1) => { x0.onchange = x1 },
      _1796: (x0,x1) => { x0.onerror = x1 },
      _2169: (x0,x1) => { x0.src = x1 },
      _2180: x0 => x0.width,
      _2182: x0 => x0.height,
      _2666: (x0,x1) => { x0.accept = x1 },
      _2680: x0 => x0.files,
      _2706: (x0,x1) => { x0.multiple = x1 },
      _2724: (x0,x1) => { x0.type = x1 },
      _3018: x0 => x0.width,
      _3019: (x0,x1) => { x0.width = x1 },
      _3020: x0 => x0.height,
      _3021: (x0,x1) => { x0.height = x1 },
      _3442: () => globalThis.window,
      _3485: x0 => x0.location,
      _3504: x0 => x0.navigator,
      _3768: x0 => x0.localStorage,
      _3776: x0 => x0.href,
      _3893: x0 => x0.userAgent,
      _3944: x0 => x0.data,
      _3991: (x0,x1) => { x0.onmessage = x1 },
      _4098: x0 => x0.length,
      _4315: x0 => x0.readyState,
      _4328: (x0,x1) => { x0.binaryType = x1 },
      _4331: x0 => x0.code,
      _4332: x0 => x0.reason,
      _6000: x0 => x0.target,
      _6040: x0 => x0.signal,
      _6112: () => globalThis.document,
      _6194: x0 => x0.body,
      _6525: (x0,x1) => { x0.id = x1 },
      _7871: x0 => x0.value,
      _7873: x0 => x0.done,
      _8053: x0 => x0.size,
      _8054: x0 => x0.type,
      _8061: x0 => x0.name,
      _8062: x0 => x0.lastModified,
      _8067: x0 => x0.length,
      _8570: x0 => x0.url,
      _8572: x0 => x0.status,
